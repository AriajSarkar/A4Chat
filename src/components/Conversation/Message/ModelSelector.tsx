...
export const ModelSelector = memo(function ModelSelector({
    ...
    const renderedModelList = useMemo(() => {
        if (filteredModels.length === 0) {
            return (
                <p className="text-text-quaternary px-4 py-6 text-center text-sm">
                    No models found
                </p>
            );
        }
            ...
            return (
                ...
                >
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <p className="text-text-quaternary truncate text-[11px]">
                            {model.providerLabel}
                        </p>
                    </div>
                    {isSelected ? <RiCheckLine className="text-accent shrink-0" size={16} /> : null}
                    <button
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            <button
                ref={triggerRef}
                className="text-text-tertiary flex items-center gap-1.5 rounded-full px-2 py-1.5 text-xs transition-colors hover:bg-white/6 md:gap-2 md:px-3 md:py-2 md:text-sm"
                onClick={() => setOpen((v) => !v)}
                type="button"
            >
                          ...
                          {open ? (
                              ...
                              >
                                  ...
                                  <div className="flex shrink-0 items-center gap-2 border-b border-white/6 px-3 py-2.5">
                                      ...
                                      />
                                      <input
                                          className="text-text-primary placeholder:text-text-quaternary min-w-0 flex-1 bg-transparent text-sm outline-none"
                                      ...
                                      <button
                                          className="text-text-quaternary hover:text-text-secondary grid size-6 shrink-0 place-items-center rounded-md transition-colors hover:bg-white/8"
                                  ...
                                  <div className="flex shrink-0 flex-wrap items-center gap-x-2 gap-y-1 border-t border-white/6 px-3 py-2">
                                      ...
                                      <span className="text-text-quaternary truncate text-xs">
                                          {displayProvider}
                                      </span>
                                      <span className="text-text-quaternary ml-auto truncate text-[11px]">
                                          {cacheAgeLabel}
                                      </span>
                                  </div>
                              </motion.div>
