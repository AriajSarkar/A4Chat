    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="imagegen-shimmer pointer-events-none absolute inset-0 bg-linear-to-r from-transparent via-white/3 to-transparent" />
            </div>
            <div className="text-text-quaternary flex items-center gap-2 text-xs">
                <span className="relative flex size-2">
                    <span className="bg-accent/40 absolute inline-flex h-full w-full animate-ping rounded-full" />
                    <span className="bg-accent/60 relative inline-flex size-2 rounded-full" />
                </span>
                Generating image…
            </div>
        </motion.div>
