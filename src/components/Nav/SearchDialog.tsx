            ...
            {open ? (
                <>
                    ...
                    <motion.div
                        ...
                        className="bg-surface-1 fixed inset-x-4 top-[15%] z-61 mx-auto max-w-xl overflow-hidden rounded-2xl border border-white/8 shadow-2xl shadow-black/40 backdrop-blur-xl md:inset-x-auto md:w-full"
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3 border-b border-white/6 px-4 py-3">
                            <RiSearchLine className="text-text-tertiary shrink-0" size={20} />
                            <input
                                className="text-text-primary placeholder:text-text-quaternary min-w-0 flex-1 bg-transparent text-[15px] outline-none"
                                onChange={(e) => {
                            ...
                            {query ? (
                                ...
                                <kbd className="text-text-quaternary hidden rounded-md border border-white/8 bg-white/4 px-1.5 py-0.5 font-mono text-xs md:inline-block">
                                    esc
                                </kbd>
                            )}
                        </div>
                        ...
                        <div className="max-h-80 overflow-y-auto p-2" ref={listRef}>
                            {filtered.length > 0 ? (
                                filtered.map((conv, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="min-w-0 flex-1">
                                            ...
                                            <div className="text-text-quaternary flex items-center gap-1.5 text-xs">
                                                <RiTimeLine size={12} />
                                        ...
                                        <button
                                            ...
                                            className="text-text-quaternary hover:bg-danger/10 hover:text-danger grid size-7 shrink-0 place-items-center rounded-lg opacity-0 transition-all group-hover:opacity-100"
                                ...
                                <div className="text-text-quaternary py-8 text-center text-sm">
                        ...
                        {filtered.length > 0 ? (
                            <div className="text-text-quaternary hidden items-center gap-4 border-t border-white/6 px-4 py-2 text-xs md:flex">
